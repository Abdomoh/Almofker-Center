    ...
    <div class="row">
      ...
      <div class="col-lg-6" data-aos="fade-up">
        <div class="testimonial-item">
          ...
          <a href="{{URL::asset('assets/img/cv/hassin_cv.pdf')}}" ><i class="bi bi-download"> {{trans('main.cv')}}</i></a>
        </div>
      </div>
      ...
      <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
        <div class="testimonial-item mt-4 mt-lg-0">
          ...
          <a href="{{URL::asset('assets/img/cv/Sahar_cv.pdf')}}"><i class="bi bi-download"> {{trans('main.cv')}}</i></a>
        </div>
      </div>
