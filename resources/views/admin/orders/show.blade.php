                ...
                <div class="card-body">
                    ...
                    <div class="row mg-t-20">
                        ...
                        <div class="col-md">
                            ...
                            <p class="invoice-info-row"><span>اسم العميل</span> <span>{{$order->user->name}}</span></p>
                            <p class="invoice-info-row"><span>هاتف العميل</span> <span>{{$order->user->phone}}</span></p>
                            <p class="invoice-info-row"><span>عنوان العميل</span> <span>{{$order->user->adress}}</span></p>
